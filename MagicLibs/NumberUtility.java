package com.nasable.stackwatch.Utility;
...
public class NumberUtility {
    ...
    public static String formatCurrency(Context context,double number) {
        AppConfigurations appConfigurations=new AppConfigurations(context);
        CountryCurrency countryCurrency=appConfigurations.getCurrency();

        NumberFormat formatter = NumberFormat.getInstance(getLocalByLangCode(countryCurrency.getCountryLanguage(),countryCurrency.getCountryCode()));
        formatter.setMaximumFractionDigits(2);
        return formatter.format(number) + " " + countryCurrency.getCurrencySymbol();
    }
    ...
    public static List<CountryCurrency> getAvailableCountries() {
        ...
        Collections.sort(countries, new Comparator<CountryCurrency>() {
            @Override
            public int compare(final NumberUtility.CountryCurrency object1, final NumberUtility.CountryCurrency object2) {
